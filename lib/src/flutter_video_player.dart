...
class EasyVideoPlayer {
  ...
  EasyVideoPlayer._(this.viewId);

  factory EasyVideoPlayer(int viewId) => EasyVideoPlayer._(viewId);

  MethodChannel get _channel => MethodChannel('easy_video_player_$viewId');
